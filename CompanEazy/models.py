...
class EmpAttendance(AuditModel):
    ...
    check_in_img = models.CharField(max_length=200, null=True, blank=True)
    check_in_remark = models.CharField(max_length=250, null=True, blank=True)
    ...
    check_out_img = models.CharField(max_length=200, null=True, blank=True)
